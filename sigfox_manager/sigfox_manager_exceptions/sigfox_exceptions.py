class SigfoxAPIException(Exception):
    def __init__(self, status_code, message="Error occurred while fetching contracts from Sigfox API"):
...
class SigfoxDeviceCreateConflictException(SigfoxAPIException):
    def __init__(selfself, message="A conflict happened with the current state of the resource."):
